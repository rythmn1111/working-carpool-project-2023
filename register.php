...
if (loggedin()) {
    ...
    $connection = mysqli_connect('localhost:2023', 'root', '', 'carpool'); // Replace with your actual database credentials

    $name = mysqli_real_escape_string($connection, $_POST['name']);
    if ($_POST['action'] == 'register') {
        // register the user
        $email = mysqli_real_escape_string($connection, $_POST['email']);
        $number = mysqli_real_escape_string($connection, $_POST['contactno']);
